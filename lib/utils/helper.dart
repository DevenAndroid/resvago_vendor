  ...
  static showImagePickerSheet({
    ...
    showCupertinoModalPopup<void>(
      ...
      builder: (BuildContext context) => CupertinoActionSheet(
        title: Text(
          'Select Image',
          style: GoogleFonts.poppins(fontWeight: FontWeight.bold, fontSize: 18, color: Colors.orange),
        ),
    ...
    OverlayEntry loader = OverlayEntry(builder: (context) {
      ...
      return Positioned(
        ...
        child: Material(
          ...
          child: LoadingAnimationWidget.fourRotatingDots(color: Colors.orange, size: 50),
        ),
      );
    });
    return loader;
