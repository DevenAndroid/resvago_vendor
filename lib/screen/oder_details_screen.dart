...
Image.asset(AppAssets.pasta),
          ...
          Column(
            ...
            crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text("jack Smith", style: GoogleFonts.poppins(
                  ...
                  Column(
                    ...
                    children: [
                      Text("Date", style: GoogleFonts.poppins(
                          ...
                          fontSize: 15),),
                      Text("24 Oct 23", style: GoogleFonts.poppins(
                          color: const Color(0xFF384953),
                          fontWeight: FontWeight.w500,
                          fontSize: 13),),
                    ],
...
SizedBox(width: 15,),
                  Column(
                    ...
                    children: [
                      Text("Time", style: GoogleFonts.poppins(
                          ...
                          fontWeight: FontWeight.w300,
                          fontSize: 15),),
                      Text("6:30PM", style: GoogleFonts.poppins(
                          color: const Color(0xFF384953),
                          fontWeight: FontWeight.w500,
                          fontSize: 13),),
                    ],
                  ...
                  Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text("Offer", style: GoogleFonts.poppins(
                          color: const Color(0xFF384953),
                          fontWeight: FontWeight.w300,
                          fontSize: 15),),
