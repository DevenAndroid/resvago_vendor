            ...
            children: [
              Expanded(
                child: ElevatedButton(
                  ...
                  child: Text(
                    slotController.slots.isEmpty ? "Create Slot".tr : "${'Slots Created'.tr} - ${slotController.slots.length}",
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return Row(
                      children: [
                        Expanded(
                          child: Text(
                            "${'Start Time'.tr}: ${item.timeSloat}",
                            style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w500),
                          ),
                        ),
                        Expanded(
                          child: Text(
                            "${'End Time'.tr}: ${item.timeSloatEnd.toString()}",
                            style: GoogleFonts.poppins(fontSize: 14, fontWeight: FontWeight.w500),
                          ),
                        ),
                        IconButton(
              ...
              Expanded(
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                      ...
                      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(5))),
                  child: Text(
                    slotController.dinnerSlots.isEmpty ? "Create Slot".tr : "${'Slots Created'.tr} - ${slotController.dinnerSlots.length}",
                    style: GoogleFonts.poppins(color: Colors.white, fontWeight: FontWeight.w500, fontSize: 15),
                  ),
                ),
              ),
